...
- [OI-wiki/OI-wiki](https://github.com/OI-wiki/OI-wiki) pushed_at:2020-12-04 :star2: Wiki of OI / ICPC for everyone. （某大型游戏线上攻略，内含炫酷算术魔法）
...
- [gollum/gollum](https://github.com/gollum/gollum) pushed_at:2020-12-01 A simple, Git-powered wiki with a sweet API and local frontend.
- [Homebrew/homebrew-cask](https://github.com/Homebrew/homebrew-cask) pushed_at:2020-12-05 🍻 A CLI workflow for the administration of macOS applications distributed as binaries
- [Homebrew/homebrew-cask-fonts](https://github.com/Homebrew/homebrew-cask-fonts) pushed_at:2020-12-04 🖋 Casks of Ｆ🅾𝓝𝐓𝚂
- [Homebrew/homebrew-core](https://github.com/Homebrew/homebrew-core) pushed_at:2020-12-05 🍻 Default formulae for the missing package manager for macOS
...
- [rust-lang/rust](https://github.com/rust-lang/rust) pushed_at:2020-12-05 Empowering everyone to build reliable and efficient software.
- [rust-lang/rust-clippy](https://github.com/rust-lang/rust-clippy) pushed_at:2020-12-04 A bunch of lints to catch common mistakes and improve your Rust code
...
- [tikv/tikv](https://github.com/tikv/tikv) pushed_at:2020-12-04 Distributed transactional key-value database, originally created to complement TiDB
...
- [gatling/gatling](https://github.com/gatling/gatling) pushed_at:2020-12-04 Modern Load Testing as Code
...
- [zio/zio](https://github.com/zio/zio) pushed_at:2020-12-04 ZIO — A type-safe, composable library for async and concurrent programming in Scala
...
- [Fmstrat/winapps](https://github.com/Fmstrat/winapps) pushed_at:2020-12-01 Run Windows apps such as Microsoft Office/Adobe in Linux (Ubuntu/Fedora) and GNOME/KDE as if they were a part of the native OS, including Nautilus integration.
...
- [exelban/stats](https://github.com/exelban/stats) pushed_at:2020-12-04 macOS system monitor in your menu bar
...
- [uw-labs/bloomrpc](https://github.com/uw-labs/bloomrpc) pushed_at:2020-11-24 GUI Client for GRPC Services
...
- [excalidraw/excalidraw](https://github.com/excalidraw/excalidraw) pushed_at:2020-12-04 Virtual whiteboard for sketching hand-drawn like diagrams
- [jaywcjlove/github-rank](https://github.com/jaywcjlove/github-rank) pushed_at:2020-12-05 🕷️Github 中国和全球用户排名，全球仓库 Star 最多排名(自动日更)。
...
- [Jigsaw-Code/outline-client](https://github.com/Jigsaw-Code/outline-client) pushed_at:2020-12-04 Outline clients, developed by Jigsaw. The Outline clients use the popular Shadowsocks protocol, and lean on the Cordova and Electron frameworks to support Windows, Android / ChromeOS, Linux, iOS and macOS.
...
- [GoogleChromeLabs/squoosh](https://github.com/GoogleChromeLabs/squoosh) pushed_at:2020-12-04 Make images smaller using best-in-class codecs, right in the browser.
- [oct16/TimeCat](https://github.com/oct16/TimeCat) pushed_at:2020-11-19 A Magical Web Recorder 🖥 (WIP) 
...
- [vlang/v](https://github.com/vlang/v) pushed_at:2020-12-05 Simple, fast, safe, compiled language for developing maintainable software. Compiles itself in <1s with zero library dependencies. https://vlang.io
